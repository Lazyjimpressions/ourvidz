...
async function generateSceneNarrativeWithOpenRouter(
  ...
  // ✅ FIX: Clean up narrative for I2I - remove asterisks and redundant "maintain" phrases
  if (useI2IIteration) {
    // Remove asterisks (used for emphasis but may confuse the model)
    narrative = narrative.replace(/\*+/g, '');
    
    // Remove redundant "maintain" phrases that are already handled by I2I
    ...
    console.log('🧹 Cleaned I2I narrative (removed asterisks and redundant maintain phrases)');
  }
