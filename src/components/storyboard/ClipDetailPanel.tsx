    ...
    <div className={cn('bg-muted/50 border-t border-border', className)}>
      ...
      {isExpanded && (
        <>
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center gap-1.5">
                    ...
                    {onPickReference && (
                      <Button
                        ...
                        size="sm"
                        onClick={onPickReference}
                        className="h-7 text-[11px] border-dashed border-muted-foreground/40"
                      >
            ...
            <div className="hidden md:block md:col-span-8 space-y-3">
              ...
              {!clip.prompt?.trim() && !clip.reference_image_url && (
                <div className="rounded-lg border border-dashed border-muted-foreground/30 bg-muted/40 p-3 text-xs text-muted-foreground space-y-1.5">
                  <p className="font-medium text-foreground/70">Getting started:</p>
                  <ol className="list-decimal list-inside space-y-0.5">
                    <li>Pick a <strong>reference image</strong> (tap the preview above)</li>
                    <li>Write or select a <strong>motion prompt</strong> below</li>
                    <li>Hit <strong>Generate</strong> to create the clip</li>
                  </ol>
                </div>
              )}
          ...
          <div className="flex items-center justify-between px-3 md:px-4 py-2 border-t border-border bg-muted/70 backdrop-blur-sm flex-wrap gap-2">
            <div className="flex items-center gap-2">
              <Button
                variant="destructive"
                size="sm"
