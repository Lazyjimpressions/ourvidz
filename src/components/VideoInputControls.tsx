  ...
  return (
    <TooltipProvider>
      <div className="bg-gray-900/90 rounded-lg p-2 border border-gray-800/50">
        {/* Row 1: VIDEO button + frame selection + prompt box + reference + two sparkle buttons */}
        <div className="flex items-start gap-3 w-full max-w-3xl mx-auto mb-2">
          {/* VIDEO Mode Button */}
          <Button
            variant="ghost"
          ...
          {/* Two Sparkle Buttons Side by Side */}
          <div className="flex gap-2">
        ...
        {/* Row 2: IMAGE button + control buttons (right-justified) */}
