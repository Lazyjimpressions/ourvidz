...
export const CharacterDetailPane: React.FC<CharacterDetailPaneProps> = ({
  ...
  return (
    <div className={cn(
      "w-80 h-full bg-background border-l border-border flex flex-col transition-transform duration-300",
        ...
        {character && (
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="font-medium text-foreground truncate">{character.name}</h3>
