    ...
    navigate(`/roleplay/chat/${config.primaryCharacterId}?scene=${config.scene.id}&fresh=true`, {
      state: {
        ...
        scenarioPayload: {
          ...
          characters: {
            partnerRole: { id: config.primaryCharacterId, name: '' },
            ...(config.secondaryCharacterId && {
              extras: [{ id: config.secondaryCharacterId, name: '' }]
            })
          },
          ...
          userCharacterId: config.userCharacterId,
          timestamp: Date.now(),
          // Required properties for ScenarioSessionPayload
          consent: { adultOnlyConfirmed: true, fictionalConfirmed: true, intensity: 'moderate', pacing: 'balanced', limits: { hard: [], soft: [] } },
          style: { perspective: 'third', messageLength: 'medium', dialogueWeight: 'balanced', initiator: 'partner' }
    ...
    <OurVidzDashboardLayout>
      <div className="w-full max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 pb-20">
        ...
        <div className="flex items-center justify-between mb-3 sm:mb-4 pt-2 sm:pt-0">
          <div>
            <h1 className="text-lg sm:text-xl font-bold text-white">Roleplay</h1>
            <p className="text-xs sm:text-sm text-muted-foreground">Chat with AI characters</p>
          </div>
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-1">
              <Button
                ...
                className="hidden sm:flex h-6 text-xs px-2"
              >
        ...
        {/* Scenario Quick-Start Section - Desktop only via CSS */}
        ...
        {/* Search and Filters - Desktop only via CSS, mobile uses bottom sheet */}
        <div className="hidden sm:block mb-4">
          <input
            type="text"
      ...
      {/* Mobile Bottom Bar - CSS controlled visibility */}
